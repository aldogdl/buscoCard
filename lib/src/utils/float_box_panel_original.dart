...
class _FloatBoxState extends State<FloatBoxPanel> {
  ...
  //Cambie el icono de apertura y cierre del menu
  IconData _iconPanelDinamic = Icons.menu;
                ...
                setState(
                  () {
                    ...
                    if (_panelState == PanelState.open) {
                      ...
                      this._iconPanelDinamic = Icons.menu;
                    } else {
                      ...
                      this._iconPanelDinamic = Icons.close;
                    }
                  },
                );
              },
              //widget.contentColor ?? Colors.white
              child: _FloatButton(
                size: widget.size ?? 70.0,
                icon: _iconPanelDinamic ?? Icons.add,
                color: Colors.red,
